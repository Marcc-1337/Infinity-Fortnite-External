...
inline void drawskeleton(uskeletalmeshcomponent* mesh, bool outline, ImColor Color, bool feet = false, bool finger = false) {
	...
	K2_DrawLineXD(Head, Neck, 1, Color);
	K2_DrawLineXD(Neck, Chest, 1, Color);
	K2_DrawLineXD(Chest, Pelvis, 1, Color);
	K2_DrawLineXD(Chest, LeftShoulder, 1, Color);
	K2_DrawLineXD(Chest, RightShoulder, 1, Color);
	K2_DrawLineXD(LeftShoulder, LeftElbow, 1, Color);
	K2_DrawLineXD(RightShoulder, RightElbow, 1, Color);
	K2_DrawLineXD(LeftElbow, LeftHand, 1, Color);
	K2_DrawLineXD(RightElbow, RightHand, 1, Color);
	K2_DrawLineXD(Pelvis, LeftLeg, 1, Color);
	K2_DrawLineXD(Pelvis, RightLeg, 1, Color);
	K2_DrawLineXD(LeftLeg, LeftThigh, 1, Color);
	K2_DrawLineXD(RightLeg, RightThigh, 1, Color);
	K2_DrawLineXD(LeftThigh, LeftFoot, 1, Color);
	K2_DrawLineXD(RightThigh, RightFoot, 2, Color);
	K2_DrawLineXD(LeftFoot, LeftFeet, 1, Color);
	K2_DrawLineXD(RightFoot, RightFeet, 1, Color);
